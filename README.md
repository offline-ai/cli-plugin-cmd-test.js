...
_See code: [@offline-ai/cli-plugin-core](https://github.com/offline-ai/cli-plugin-core.js/blob/v0.11.3/src/commands/run/index.ts)_
...
_See code: [src/commands/test/index.ts](https://github.com/offline-ai/cli-plugin-cmd-test.js/blob/v0.3.13/src/commands/test/index.ts)_
<!-- commandsstop -->
